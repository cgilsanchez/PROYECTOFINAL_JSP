...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Userify</a>

  <ul class="navbar-nav flex-row">
    <li class="nav-item text-nowrap">
      <p class="nav-link px-3 text-white"><% if(user!=null) out.print(user.getUsername());%></p>
    </li>
  </ul>
